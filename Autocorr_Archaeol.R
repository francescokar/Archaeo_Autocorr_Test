...
tiff("RR_FB031.tif",width=6000,height=4800,units="px",res=800)
par(mar=c(0,0,4,0))
...
tiff("Geary-correlogram_spdep.tif",width=6000,height=4800,units="px",res=800)
par(mar=c(5,5,5,3))
par(cex=1.3)
par(cex.main=1.2)
...
tiff("Correlog_pgirmess.tif",width=6000,height=6000,units="px",res=800)
par(mar=c(5,5,5,3))
par(mfrow=c(2,1))
par(cex=1.2)
plot(RRcorrel,main="Moran's I correlogram log-size of RR")
...
tiff("Mantel_correlog.tif",width=6000,height=4800,units="px",res=800)
par(mar=c(5,5,5,3))
par(cex=1.2)
...
tiff("LocalG.tif",width=6000,height=4800,units="px",res=800)
par(mar=c(0,2,5,0))
...
tiff("Variogram_gstat.tif",width=4800,height=4800,units="px",res=800)
par(mar=c(5,5,3,2))
...
RRdirectvar<-variogram(RR_FB031$Dimensio_1~1,RR_FB031,alpha=c(0,45,90,135),
                       cutoff=150,width=15)
tiff("Directvariogram_gstat.tif",width=4800,height=4800,units="px",res=800)
...
tiff("Variog_geoR.tif",width=4800,height=4800,units="px",res=800)
par(mar=c(5,5,3,2))
...
tiff("Lcross.tif",width=4800,height=4800,units="px",res=800)
par(mar=c(5,5,5,3))
...
RRJCS_pch<-c(4,16,1)
tiff("LICD.tif",width=6000,height=4800,units="px",res=800)
par(mar=c(0,2,5,0))
...
tiff("Preservation.tif",width=6000,height=4800,units="px",res=800)
par(mar=c(0,2,5,0))
